<div
    class="flex flex-col lg:flex-row gap-10 h-screen justify-center items-center">
    <form wire:submit.prevent="submit">
        ...
        <div
            class="font-semibold bg-green-400 container text-end leading-8 text-gray-50">
        </div>
    ...
    <div class="overflow-x-auto mt-2 flex flex-col gap-2">
        ...
        <div class="badge badge-primary mx-auto">Users not found...</div>
